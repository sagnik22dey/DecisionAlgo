...
async def dashboard_love_style():
    return """
        ...
        .features-section {
            width: 100%;
            padding: 5vh 2vw 10vh 2vw; /* Vertical padding using vh, horizontal with vw */
            text-align: center;
        ...
        .section-title .highlight {
            color: #5FC7FB; /* Blue highlight color */
        }
