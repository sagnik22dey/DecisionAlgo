    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Adjust overlay for centered text */
            #insurance-hero::before {
                background: linear-gradient(to top, rgba(0, 0, 0, 0.85) 15%, rgba(0, 0, 0, 0.1) 70%);
            }
            ...
            #insurance-hero h1 {
                ...
                line-height: 1.25;
                margin-bottom: 5vh;
                /* The complex gradient background is inherited */
            }
